...
{
    int W = 0, H = 0;
    int text_h = 0, space_w = 0, longest_w = 0;
    float x_words = 0.f, y_words = 0.f, max_w = 0.f;
    float x_entry = 0.f, y_entry = 0.f;
};


inline Layout compute_layout(SDL_Renderer *ren, int text_h, int space_w, int longest_w) {
  Layout L;
  SDL_GetRenderOutputSize(ren, &L.W, &L.H);
  L.text_h = text_h; L.space_w = space_w; L.longest_w = longest_w;
